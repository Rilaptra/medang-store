                              ...
                              {form.watch(`variations.${index}.images`) &&
                                form
                                  ...
                                  .map((image, imageIndex) => (
                                    <div
                                      key={imageIndex}
                                      className="relative w-20 h-20 rounded-md border overflow-hidden mr-2 mb-2"
                                    >
                                      <img
                                        src={image}
                                        alt="Uploaded"
                                      ...
                                      <Button
                                        ...
                                        variant="destructive"
                                        size="icon"
                                        className="absolute top-1 right-1 p-1 rounded-full bg-white/80 hover:bg-white/100 "
                                        onClick={() =>
